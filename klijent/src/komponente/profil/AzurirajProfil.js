...
import { napraviProfil, uzmiTrenutniProfil } from "../../actions/profil";
import {
  faFacebookF,
  faTwitter,
  faYoutube,
...
const AzurirajProfil = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      restoran: loadovanje || !profil.restoran ? "" : profil.restoran,
      websajt: loadovanje || !profil.websajt ? "" : profil.websajt,
      lokacija: loadovanje || !profil.lokacija ? "" : profil.lokacija,
      status: loadovanje || !profil.status ? "" : profil.status,
      kuhinjskeVestine:
        loadovanje || !profil.kuhinjskeVestine
          ? ""
          : profil.kuhinjskeVestine.join(","),
      biografija: loadovanje || !profil.biografija ? "" : profil.biografija,
      youtube:
        loadovanje || !profil.socijalnemreze || !profil.socijalnemreze.youtube
          ? ""
          : profil.socijalnemreze.youtube,
      facebook:
        loadovanje || !profil.socijalnemreze || !profil.socijalnemreze.facebook
          ? ""
          : profil.socijalnemreze.facebook,
      instagram:
        loadovanje || !profil.socijalnemreze || !profil.socijalnemreze.instagram
          ? ""
          : profil.socijalnemreze.instagram,
      linkedin:
        loadovanje || !profil.socijalnemreze || !profil.socijalnemreze.linkedin
          ? ""
          : profil.socijalnemreze.linkedin,
      twitter:
        loadovanje || !profil.socijalnemreze || !profil.socijalnemreze.twitter
          ? ""
          : profil.socijalnemreze.twitter
    });
  }, [loadovanje]);
  ...
  const onSubmit = e => {
    e.preventDefault();
    napraviProfil(formData, history, true);
  };
...
export default connect(
  mapStateToProps,
  { napraviProfil, uzmiTrenutniProfil }
)(withRouter(AzurirajProfil));
